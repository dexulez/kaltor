...
export const SUB_PERMISOS: Partial<Record<ModuloKey, { key: string; label: string; desc: string }[]>> = {
  ...
  caja: [
    ...
    { key: 'caja.corregir_caja',         label: 'Corregir cajas anteriores',  desc: 'Editar un cierre ya registrado o registrar una caja de un día anterior' },
  ],
  compras: [
...
const SUB_DEFAULT: Record<string, Record<string, boolean>> = {
  administrador: {
    ...
    'caja.crear_producto_rapido': true, 'caja.aplicar_descuento': true, 'caja.gestionar_sesion': true, 'caja.corregir_caja': true,
  ...
  tecnico: {
    ...
    'caja.crear_producto_rapido': false, 'caja.aplicar_descuento': false, 'caja.gestionar_sesion': false, 'caja.corregir_caja': false,
  ...
  vendedor: {
    ...
    'caja.crear_producto_rapido': true, 'caja.aplicar_descuento': false, 'caja.gestionar_sesion': true, 'caja.corregir_caja': false,
    'compras.crear': false, 'compras.recibir': false, 'compras.editar': false, 'compras.editar_recibidas': false, 'compras.pagar': false, 'compras.cancelar': false, 'compras.proveedores': false,
    'usuarios.crear': false, 'usuarios.editar': false, 'usuarios.editar_permisos': false, 'usuarios.eliminar': false,
